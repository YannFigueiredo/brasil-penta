...
export default function Momentos(){
    const [momentos, setMomentos] = useState([
        ...
        {id: 4, titulo: 'Cafu levanta a taça da copa', data: '30 jun 2002', capa: cafutrofeu, video: 'https://www.youtube.com/watch?v=AzXYGdyfV4o'}
    ]);
            ...
            <div className="container-momentos">
                {
                    momentos.map(momento => (
                        <a href={momento.video} target="blank" key={momento.id}>
                            <article className="momento">
